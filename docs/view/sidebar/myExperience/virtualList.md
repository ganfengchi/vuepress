...
![alt](../../../../docs/.vuepress/public/images/virtualList_03.webp)
...
接着，监听`infinite-list-container的scroll`事件，获取滚动位置 scrollTop
...
* 可视区域：screen
* 可视区域下方：below
![alt](../../../../docs/.vuepress/public/images/virtualList_07.webp)
```js
